...
# ============1.打开图片============
file='/Volumes/Amber‘s HP/dataset/sky/datasets/labelmefacade/min_gt/'
...
for x in files:
    ...
    for x in range(0, width):
        for y in range(0, height):
            ...
            if r==0 and b == 128 and g == 128:  # 判断规则
    ...
    img.save("/Volumes/Amber‘s HP/dataset/sky/datasets/labelmefacade//mod_gt/"+path)
'''
